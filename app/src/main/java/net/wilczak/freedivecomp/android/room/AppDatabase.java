...
@Database(entities = {RaceEntity.class, RulesEntity.class, StartEntity.class, StartingLanesEntity.class, DisciplinesEntity.class}, version = 1)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract DisciplinesDao disciplinesDao();
}
